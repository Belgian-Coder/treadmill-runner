...
namespace TreadmillRunner.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260910163254_AddPolarH10Memory")]
    partial class AddPolarH10Memory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TreadmillRunner.Infrastructure.Persistence.GarminActivityUploadAccountEntity", b =>
                {
                    ...
                    b.Property<string>("WatchActivityHandling")
                        .IsRequired()
                        .HasMaxLength(30)
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("GarminActivityUploadAccounts", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_GarminActivityUploadAccounts_WatchHandling", "\"WatchActivityHandling\" IN ('PreferWatch', 'MergeAndReplace')");
                        });
                });
            ...
            modelBuilder.Entity("TreadmillRunner.Infrastructure.Persistence.GarminActivityUploadJobEntity", b =>
                {
                    ...
                    b.Property<string>("MatchEvidence")
                        .HasMaxLength(1000)
                        .HasColumnType("TEXT");

                    b.Property<string>("MatchedRemoteId")
                        .HasMaxLength(256)
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("ReplacementRemoteId")
                        .HasMaxLength(256)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("TreadmillRunner.Infrastructure.Persistence.PolarH10RecordingEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("ExternalRecordingId")
                        .HasMaxLength(256)
                        .HasColumnType("TEXT");
                    ...
                    b.Property<DateTimeOffset?>("StartConfirmedAtUtc")
                        .HasColumnType("TEXT");

                    b.Property<DateTimeOffset?>("StartRequestedAtUtc")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<DateTimeOffset?>("StopConfirmedAtUtc")
                        .HasColumnType("TEXT");

                    b.Property<DateTimeOffset?>("StopRequestedAtUtc")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("WorkoutSessionId")
                        .IsUnique()
                        .HasFilter("\"WorkoutSessionId\" IS NOT NULL");

                    b.HasIndex("DeviceEnrollmentId", "ExerciseId")
                        .IsUnique();

                    b.HasIndex("DeviceEnrollmentId", "RemotePath")
                        .IsUnique()
                        .HasFilter("\"RemotePath\" IS NOT NULL");

                    b.HasIndex("Status", "LeaseExpiresAtUtc");

                    b.ToTable("PolarH10Recordings", null, t =>
                        {
                            t.HasCheckConstraint("CK_PolarH10Recordings_Attempts", "\"AttemptCount\" >= 0");

                            t.HasCheckConstraint("CK_PolarH10Recordings_Exercise", "length(\"ExerciseId\") BETWEEN 1 AND 64");

                            t.HasCheckConstraint("CK_PolarH10Recordings_Status", "\"Status\" IN ('StartPending','Recording','StopPending','AwaitingDevice','Downloading','Downloaded','ReviewRequired','Merging','Merged','RemovalPending','Completed','Retained','Skipped','NotStarted','DiscardCleanupPending','Retryable')");
                        });
                });

            modelBuilder.Entity("TreadmillRunner.Infrastructure.Persistence.PolarH10RecordingSampleEntity", b =>
                {
                    b.Property<Guid>("PolarH10RecordingId")
                        .HasColumnType("TEXT");

                    b.Property<long>("Sequence")
                        .HasColumnType("INTEGER");

                    b.Property<ushort?>("BeatsPerMinute")
                        .HasColumnType("INTEGER");

                    b.Property<DateTimeOffset>("CapturedAtUtc")
                        .HasColumnType("TEXT");

                    b.Property<uint?>("RrIntervalMilliseconds")
                        .HasColumnType("INTEGER");

                    b.HasKey("PolarH10RecordingId", "Sequence");

                    b.HasIndex("PolarH10RecordingId", "CapturedAtUtc");

                    b.ToTable("PolarH10RecordingSamples", (string)null);
                });
            ...
            modelBuilder.Entity("TreadmillRunner.Infrastructure.Persistence.WorkoutSessionEntity", b =>
                {
                    ...
                    b.Property<bool>("RecordPolarH10Memory")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("UserProfileId", "EndedAtUtc")
            ...
            modelBuilder.Entity("TreadmillRunner.Infrastructure.Persistence.PolarH10RecordingEntity", b =>
                {
                    b.HasOne("TreadmillRunner.Infrastructure.Persistence.DeviceEnrollmentEntity", null)
                        .WithMany()
                        .HasForeignKey("DeviceEnrollmentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("TreadmillRunner.Infrastructure.Persistence.PolarH10RecordingSampleEntity", b =>
                {
                    b.HasOne("TreadmillRunner.Infrastructure.Persistence.PolarH10RecordingEntity", "Recording")
                        .WithMany()
                        .HasForeignKey("PolarH10RecordingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
