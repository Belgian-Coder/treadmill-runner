...
9. Review planned/requested/measured speed and incline on labelled independent axes in the history page and read-only history sheet, alongside HR-zone duration, adherence, event counts, and current-week completed totals.
