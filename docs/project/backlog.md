...
| [TR-016](stories/tr-016-tag-driven-github-releases.md) | Tag-driven signed GitHub releases without per-commit Actions builds | implemented; validation in progress | Signing key remains local; tags are immutable and never force-moved |
