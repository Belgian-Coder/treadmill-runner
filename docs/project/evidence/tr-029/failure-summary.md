...
- The first Control pass could not see seeded workouts because the test did not open the new collapsed **Choose another run** section. Shared browser helpers now exercise the intended interaction.
