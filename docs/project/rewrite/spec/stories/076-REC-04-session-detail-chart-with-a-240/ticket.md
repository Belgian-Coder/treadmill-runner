...
# REC-04 — Session detail: chart with a 240-point projection and the true count, splits, zones, adher

## Goal
Session detail: chart with a 240-point projection and the true count, splits, zones, adherence.
