...
# REC-02 — RPE (1–10) and a note (≤ 1,000 characters) after the run, editable later (phone and web).

## Goal
RPE (1–10) and a note (≤ 1,000 characters) after the run, editable later (phone and web).
