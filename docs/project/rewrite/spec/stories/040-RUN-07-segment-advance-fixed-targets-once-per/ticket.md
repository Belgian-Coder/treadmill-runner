...
# RUN-07 — Segment advance; fixed targets once per segment; overrides within the segment.

## Goal
Segment advance; fixed targets once per segment; overrides within the segment.
