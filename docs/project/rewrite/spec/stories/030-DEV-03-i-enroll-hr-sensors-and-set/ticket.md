...
# DEV-03 — As a runner, I enroll HR sensors and set preferred and fallback order per profile.

## Goal
As a runner, I enroll HR sensors and set preferred and fallback order per profile.
